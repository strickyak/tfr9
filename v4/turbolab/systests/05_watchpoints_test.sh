...
run_tether -n --watch=0x1000 --stop=c:200 "$DATA_DIR/bootable/pi.decb"
...
run_tether -n --watch=0x1000,0x1002,0x1004 --stop=c:200 "$DATA_DIR/bootable/pi.decb"
...
run_tether -n --watch=0x1019:3 --stop=c:120 "$DATA_DIR/bootable/pi.decb"
...
run_tether -n --watch=@kernel+0x1B --stop=c:50k "$BUILD_DIR/turbos/turbos_core.img"
...
run_tether -n --watch=0x1000 --trigger=c:60 --trace=x --stop=c:100 "$DATA_DIR/bootable/pi.decb"
